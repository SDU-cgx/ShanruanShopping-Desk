<template>
  <div class="register">
    <el-form ref="form" :model="form" :rules="rules" class="register-form">
      <h3 class="title">成为商城商户</h3>

      <el-form-item prop="name">
        <el-input v-model="form.name" type="text" autocomplete="off" placeholder="店铺名称">
    ...
    <div class="el-login-footer">
      <span><router-link to="/register" style="color:#579DCA antiquewhite;">用户注册</router-link></span>
      <span>&nbsp;&nbsp;&nbsp;</span>
