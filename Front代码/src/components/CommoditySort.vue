<template>
    <div class="commoidtySort">
        <div class="sort">
            <a href="javascript:;" class="curr" @click="getCommodityList(0, 'price')"><span>综合</span><i
                    class="arrow"></i></a>
            <a href="javascript:;" @click="getCommodityList('')"><span>销量</span><i class="arrow"></i></a>
            <a href="javascript:;" @click="getCommodityList(0, 'comment')"><span>评论数</span><i class="arrow"></i></a>
            <!-- <a href="javascript:;" @click="getCommodityList('')"><span>新品</span><i class="arrow"></a> -->
            <a href="javascript:;" @click="getCommodityList(sortType, 'price')"><span>价格</span><i class="arrow"></i></a>
        </div>
